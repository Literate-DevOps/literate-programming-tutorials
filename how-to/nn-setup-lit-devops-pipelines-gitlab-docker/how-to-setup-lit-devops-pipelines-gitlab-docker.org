...
2. Add ~mode~ line to top of the file.
   ...
   #+begin_quote 
     ...
     *Answer:* The default values for =org-babel-noweb-wrap-start= (\lt\lrm\lt) and =org-babel-noweb-wrap-end= (\gt\lrm\gt), collide with the operators of some common programming languages. These collisions can break the syntax highlighting and interfere with code maintenance.
   #+end_quote
